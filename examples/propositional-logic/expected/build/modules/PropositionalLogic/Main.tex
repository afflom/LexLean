...
Assume \(h\).
Consider the cases of \(h\).
Case \(andintro\) with \(hp\), \(hqr\):
Consider the cases of \(hqr\).
Case \(andintro\) with \(hq\), \(hr\):
Branch \(1\):
Branch \(1\):
The goal follows from \(hp\).
Branch \(2\):
...
For every proposition \(p\) and proposition \(q\) and proposition \(r\), if \(p\) or \(q\), then if \(p \to r\), then if \(q \to r\), then \(r\).
\end{theorem}
\begin{proof}
Assume \(hpq\), \(hpr\), \(hqr\).
Consider the cases of \(hpq\).
